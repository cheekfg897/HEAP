<template>
  <div style="padding: 20px; font-family: Arial, sans-serif; max-width: 1200px; margin: 0 auto;">
    ...
    <div style="margin: 1rem 0; display: flex; gap: 10px; flex-wrap: wrap;">
      <button @click="printPreview" style="padding: 8px 12px; border: 1px solid #ccc; border-radius: 4px; cursor: pointer; background: #f8f9fa; display: flex; align-items: center; gap: 5px;">
        🖨️ Print Preview
      </button>
